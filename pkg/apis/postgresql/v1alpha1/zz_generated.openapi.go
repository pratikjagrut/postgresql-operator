...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/postgresql-operator/pkg/apis/postgresql/v1alpha1.Backup":         schema_pkg_apis_postgresql_v1alpha1_Backup(ref),
		"github.com/postgresql-operator/pkg/apis/postgresql/v1alpha1.BackupSpec":     schema_pkg_apis_postgresql_v1alpha1_BackupSpec(ref),
		"github.com/postgresql-operator/pkg/apis/postgresql/v1alpha1.BackupStatus":   schema_pkg_apis_postgresql_v1alpha1_BackupStatus(ref),
		"github.com/postgresql-operator/pkg/apis/postgresql/v1alpha1.Database":       schema_pkg_apis_postgresql_v1alpha1_Database(ref),
		"github.com/postgresql-operator/pkg/apis/postgresql/v1alpha1.DatabaseSpec":   schema_pkg_apis_postgresql_v1alpha1_DatabaseSpec(ref),
		"github.com/postgresql-operator/pkg/apis/postgresql/v1alpha1.DatabaseStatus": schema_pkg_apis_postgresql_v1alpha1_DatabaseStatus(ref),
	}
}
...
func schema_pkg_apis_postgresql_v1alpha1_Backup(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/postgresql-operator/pkg/apis/postgresql/v1alpha1.BackupSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/postgresql-operator/pkg/apis/postgresql/v1alpha1.BackupStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/postgresql-operator/pkg/apis/postgresql/v1alpha1.BackupSpec", "github.com/postgresql-operator/pkg/apis/postgresql/v1alpha1.BackupStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_postgresql_v1alpha1_Database(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/postgresql-operator/pkg/apis/postgresql/v1alpha1.DatabaseSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/postgresql-operator/pkg/apis/postgresql/v1alpha1.DatabaseStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/postgresql-operator/pkg/apis/postgresql/v1alpha1.DatabaseSpec", "github.com/postgresql-operator/pkg/apis/postgresql/v1alpha1.DatabaseStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
